...
const useResizeObserver = (callback: () => void, elements: React.RefObject<Element | null>[], dependencies: React.DependencyList) => {
  useEffect(() => {
...
export type LogoItem = 
  | { node: React.ReactNode; ariaLabel?: string; title?: string; href?: string }
...
export const LogoLoop = memo(
  ({
    ...
    useResizeObserver(updateDimensions, [containerRef, seqRef] as any, [logos, gap, logoHeight, isVertical]);
